...
I'm really *not* that old, but things in the tech world move fast and there weren't as many resources around to help people get into frontend development and learn how to build something from HTML, CSS, JavaScript, etc. There wasn't as many great communitys like Dev or Hashnode or WeStryve, not learning platforms such as Free Code Camp or The Odin Project.
...
*(Pssst -- If you like this article, come* *[Follow me on Mastodon @kendalmintcode@indieweb.social](https://indieweb.social/@kendalmintcode)* *where I post regular helpful content every day)*
